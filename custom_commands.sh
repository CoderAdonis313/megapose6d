...
python -m megapose.scripts.run_inference_on_custom_object "${1:-baygon}" --vis-detections
...
python -m megapose.scripts.run_inference_on_custom_object "${1:-baygon}" --vis-outputs
